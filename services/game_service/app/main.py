...
from services.game_service.app.message_handler import start_consumer_thread
from services.game_service.app.db import user_states
from services.game_service.app.game_logic import get_user, start_game_for_user, update_guess, end_game_for_user
